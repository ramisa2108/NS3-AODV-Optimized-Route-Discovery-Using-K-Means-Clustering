 ...
 */
#ifndef aodvKmeansPACKET_H
#define aodvKmeansPACKET_H
...
enum MessageType
{
  aodvKmeansTYPE_RREQ  = 1,   //!< aodvKmeansTYPE_RREQ
  aodvKmeansTYPE_RREP  = 2,   //!< aodvKmeansTYPE_RREP
  aodvKmeansTYPE_RERR  = 3,   //!< aodvKmeansTYPE_RERR
  aodvKmeansTYPE_RREP_ACK = 4 //!< aodvKmeansTYPE_RREP_ACK
};

/**
* \ingroup aodvKmeans
* \brief aodvKmeans types
*/
...
public:
  /**
   * constructor
   * \param t the aodvKmeans RREQ type
   */
  TypeHeader (MessageType t = aodvKmeansTYPE_RREQ);
