 ...
 */
#ifndef aodvKmeansROUTINGPROTOCOL_H
#define aodvKmeansROUTINGPROTOCOL_H
 ...
 * \ingroup aodvKmeans
 *
 * \brief aodvKmeans routing protocol
 */
...
public:
  ...
  static const uint32_t aodvKmeans_PORT;
...
private:
   ...
   */
  void RecvaodvKmeans (Ptr<Socket> socket);
  /**
   * Receive RREQ
   * \param p packet
   ...
   * \param destination - destination node IP address
   */
  void kmeans (Ptr<Socket> socket, Ptr<Packet> packet, Ipv4Address destination);
...
#endif /* aodvKmeansROUTINGPROTOCOL_H */
