 ...
 */
#ifndef aodvKmeans_RQUEUE_H
#define aodvKmeans_RQUEUE_H
...
/**
 * \ingroup aodvKmeans
 * \brief aodvKmeans route request queue
 *
 * Since aodvKmeans is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
